  ...
  useEffect(() => {
    ...
    const fs = `
      ...
      void main() {
          ...
          vec3 color1 = vec3(0.04, 0.02, 0.08); // Deep Velvet Plum
          vec3 color2 = vec3(0.18, 0.03, 0.32); // Luminous Cosmic Purple
          vec3 color3 = vec3(0.04, 0.12, 0.22); // Nebula Teal
          
          vec3 mixedColor = mix(color1, color2, noise1 * 0.5 + 0.5);
          mixedColor = mix(mixedColor, color3, noise2 * 0.5 + 0.5);
